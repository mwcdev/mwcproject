<?php 
    ...
    $pageData->title = "လိုဂိုနှင့် ဂရက်ဖစ်ဒီဇိုင်း ရေးဆွဲခြင်း ဝန်ဆောင်မှု";
    include("header.php");
?>
           ...
           <div class="container">
                <div class="row align-items-center standard-padding-semi-bottom">
                    <div class="col-md-6 my-md-0 my-3">
                        <h1>လိုဂိုနှင့် ဂရက်ဖစ်ဒီဇိုင်း ရေးဆွဲခြင်း ဝန်ဆောင်မှု</h1>
                        <div class="content">
                            <p>ကိုယ့်လုပ်ငန်းကို ဖောက်သည်တွေနဲ့ ပိုမိုနီးကပ်လာအောင် ပထမဆုံးအနေနဲ့ လုပ်ဆောင်ပေးတာ လိုဂိုနှင့် ဂရက်ဖစ်ဒီဇိုင်းတွေပါ...</p>
                        </div>
                        <!-- <a class="btn btn-outline-primary mt-4" href="#" role="button" tabindex="0">Let's Get Start</a> -->
                    </div>
                    <div class="col-md-6">
                        <img src="<?php echo PJ_ASSETS_URI; ?>/img/graphic.png" alt="">
                    </div>
                </div>
           </div>
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="sub-heading">
                            ...
                            <h2>Branding Allows You to be Different <br><span>While Staying the Same</span></h2>
                    </div>
                    <div class="content">
                        <p>Branding has never been more expansive adventurous and agile</p>
                        <p>Its touchpoints are constantly spilling over into new ways to engage with your audience. Nowadays, a brand voice can literally mean a brand voice (we’re talking to you Siri and Alexa). Your once sacred, brand guideline protected logo can now shapeshift into a new wordmark every day (we’re looking at you Google). </p>    
                        <p>Our seasoned brand tenders are always stirring up something refreshing. And with these ever-evolving brand parameters, you need to tap into a resource that knows how to adapt to it all. With the aim not to keep up, but to lead. That’s where we come in. Mixing an inviting concoction of sound strategic insights with a generous splash of creativity to serve up a potent brand ecosystem that increases the value of your company, motivates your workforce and quenches customers’ thirst for your product. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="standard-padding bg-light-blue">
        <div class="container">
        <div class="sub-heading">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1429 713" width="90" height="45">
                                <path id="Layer" class="shp0" d="M999.3 0.91C1139.35 0.91 1279.4 0.94 1419.44 1C1422.61 1 1425.77 2.49 1428.93 3.28C1426.82 6.01 1424.4 8.56 1422.63 11.5C1283.74 242.17 1144.89 472.83 1006.09 703.5C1004.31 706.5 1003.09 709.8 1001.68 712.96L572.05 712.96C573.94 709.51 575.7 705.96 577.73 702.63C703.01 494.55 828.29 286.45 953.58 78.34C969 52.66 984.08 26.72 999.3 0.91Z" />
